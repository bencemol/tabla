...
const variants = {
  ...
  ghost:
    "bg-transparent border-dashed border-zinc-200 dark:border-zinc-800 focus:border-transparent hover:border-transparent text-zinc-200 hover:text-inherit focus-visible:focus-within:text-inherit dark:text-zinc-800 hover:bg-zinc-100 focus:bg-zinc-100 dark:focus:bg-zinc-800 dark:hover:bg-zinc-800",
};
